...
- Change landed: `software-factory/scripts/workflow-memory/add-entry.ts`, [`software-factory/workflow-memory/README.md`](./README.md), workflow protocol updates.
- Evidence: [`software-factory/workflow-memory/README.md`](./README.md), `software-factory/scripts/workflow-memory/add-entry.ts`, [`software-factory/workflows/README.md`](../workflows/README.md)
- Owner: automation
- Status: active
...
- Change landed: `software-factory/scripts/workflow-memory/check-coverage.ts`, `package.json` workflow-memory scripts, skill/doc requirements for event id evidence and weekly coverage checks.
- Evidence: `software-factory/scripts/workflow-memory/check-coverage.ts`, [`software-factory/workflow-memory/README.md`](./README.md), [`software-factory/workflows/README.md`](../workflows/README.md), [`.agents/skills/periodic-scans/SKILL.md`](../../.agents/skills/periodic-scans/SKILL.md)
- Owner: automation
- Status: active
...
- Control type: automation + docs rule
- Change landed: `software-factory/scripts/skills/check-quality.ts`, `skills:check:strict` command, workflow/docs updates requiring quality checks after skill edits.
- Evidence: `software-factory/scripts/skills/check-quality.ts`, `package.json`, [`software-factory/workflows/README.md`](../workflows/README.md), [`AGENTS.md`](../../AGENTS.md), [`CLAUDE.md`](../../CLAUDE.md)
- Owner: automation
- Status: active
...
- Evidence: [`software-factory/workflow-memory/taxonomy.md`](./taxonomy.md), `software-factory/scripts/workflow-memory/add-entry.ts`, [`software-factory/workflows/README.md`](../workflows/README.md), [`.agents/skills/periodic-scans/SKILL.md`](../../.agents/skills/periodic-scans/SKILL.md), [`.agents/skills/self-improvement/SKILL.md`](../../.agents/skills/self-improvement/SKILL.md)
- Owner: automation
- Status: active
