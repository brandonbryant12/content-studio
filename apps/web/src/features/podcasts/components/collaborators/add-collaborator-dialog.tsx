// features/podcasts/components/collaborators/add-collaborator-dialog.tsx
...
export function AddCollaboratorDialog({
  ...
  return (
    <BaseDialog
      ...
      description="Invite someone to collaborate on this podcast."
      maxWidth="md"
      footer={{
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={`mt-1.5 ${showError ? 'border-destructive focus-visible:ring-destructive/20' : ''}`}
            autoComplete="email"
            autoFocus
          />
          {showError && (
