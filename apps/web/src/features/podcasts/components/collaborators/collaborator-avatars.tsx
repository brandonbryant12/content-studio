// features/podcasts/components/collaborators/collaborator-avatars.tsx
...
function AvatarItem({
  ...
  return (
    ...
    >
      <Avatar
        className={`collab-avatar ${isPending ? 'collab-avatar-pending' : ''} ${isOwner ? 'collab-avatar-owner' : ''}`}
      >
...
export function CollaboratorAvatars({
  ...
  return (
    <button
      ...
      aria-label={`${totalCount} collaborator${totalCount !== 1 ? 's' : ''}. Click to manage.`}
    >
