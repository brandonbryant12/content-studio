...
Workflow tests share the same runtime setup as integration tests. See [`docs/testing/integration-tests.md`](./integration-tests.md) for `createTestRuntime`, `createPGliteTestContext`, and mock layer configuration. The runtime must include the job queue layer.
