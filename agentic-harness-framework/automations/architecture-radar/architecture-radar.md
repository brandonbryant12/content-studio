...
- Compare findings against [`AGENTS.md`](../../../AGENTS.md), [`CLAUDE.md`](../../../CLAUDE.md), [`agentic-harness-framework/workflows/README.md`](../../../agentic-harness-framework/workflows/README.md), [`agentic-harness-framework/workflow-memory/guardrails.md`](../../../agentic-harness-framework/workflow-memory/guardrails.md), docs/patterns/*.md, docs/frontend/*.md, docs/testing/*.md, and relevant code.
