...
export const chatPersonaSystemPrompt = definePrompt({
  ...
  riskTier: 'medium',
  status: 'active',
  summary: 'Guides conversational persona definition before synthesis.',
...
- Consider speaking style, personality quirks, expertise areas, and how they would interact with other hosts
