...
const documentRouter = {
  list: protectedProcedure.documents.list.handler(async ({ context, input, errors }) => {
    return handleEffect(
      Effect.gen(function* () {
  ...
  get: protectedProcedure.documents.get.handler(async ({ context, input, errors }) => {
    return handleEffect(
      Effect.gen(function* () {
        const documents = yield* Documents;
  ...
  getContent: protectedProcedure.documents.getContent.handler(async ({ context, input, errors }) => {
    return handleEffect(
      Effect.gen(function* () {
        const documents = yield* Documents;
      ...
      }).pipe(Effect.provide(context.layers)),
      {
        ...
        StorageError: (e) => {
          ...
          throw errors.INTERNAL_ERROR({ message: 'Failed to retrieve document content' });
        },
  ...
  create: protectedProcedure.documents.create.handler(async ({ context, input, errors }) => {
    return handleEffect(
      Effect.gen(function* () {
        const documents = yield* Documents;
      ...
      }).pipe(Effect.provide(context.layers)),
      {
        ...
        StorageUploadError: (e) => {
          ...
          throw errors.INTERNAL_ERROR({ message: 'Failed to store document content' });
        },
      },
    );
  }),

  upload: protectedProcedure.documents.upload.handler(async ({ context, input, errors }) => {
    return handleEffect(
      Effect.gen(function* () {
        const documents = yield* Documents;
      ...
      }).pipe(Effect.provide(context.layers)),
      {
        ...
        StorageUploadError: (e) => {
          console.error('[StorageUploadError]', e.message, e.cause);
          throw errors.INTERNAL_ERROR({ message: 'Failed to store document' });
        },
  ...
  update: protectedProcedure.documents.update.handler(async ({ context, input, errors }) => {
    const { id, ...data } = input;
    ...
    return handleEffect(
      ...
      }).pipe(Effect.provide(context.layers)),
      {
        ...
        StorageUploadError: (e) => {
          console.error('[StorageUploadError]', e.message, e.cause);
          throw errors.INTERNAL_ERROR({ message: 'Failed to update document content' });
        },
        StorageError: (e) => {
          console.error('[StorageError]', e.message, e.cause);
          throw errors.INTERNAL_ERROR({ message: 'Storage operation failed' });
        },
      },
    );
  }),

  delete: protectedProcedure.documents.delete.handler(async ({ context, input, errors }) => {
    return handleEffect(
      Effect.gen(function* () {
        const documents = yield* Documents;
      ...
      }).pipe(Effect.provide(context.layers)),
      {
        ...
        StorageError: (e) => {
          console.error('[StorageError]', e.message, e.cause);
          throw errors.INTERNAL_ERROR({ message: 'Failed to delete document from storage' });
        },
      },
    );
  }),
